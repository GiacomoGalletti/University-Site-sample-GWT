...
var $strongName = '2FFD872A8F2F57233454D57BCD7421E7';
var $gwt = {};
...
function $setSessionToLogout(this$static){
  if ((!currentSession && (currentSession = new Session(($clinit_State() , NOT_SIGNED))) , currentSession).tipo != ($clinit_State() , NOT_SIGNED) && this$static.buttonLogin.element.innerText == 'logout') {
...
function InfoViewComponent(){
  ...
  this.txta1.element.style['height'] = '150px';
}
  ...
  if (!$equals_1($getPropertyString(this.this$01.courseNameBox.element, 'value'), '') && !$equals_1($getPropertyString(this.this$01.startDateBox.element, 'value'), '') && !$equals_1($getPropertyString(this.this$01.endDateBox.element, 'value'), '')) {
    try {
      ...
      if (gt(fromDouble_0(end.jsdate.getTime()), fromDouble_0(start_0.jsdate.getTime())) && $after(start_0, new Date_0)) {
        !connService && (connService = new ConnService_Proxy);
        $addCourse(connService, $getPropertyString(this.this$01.courseNameBox.element, 'value'), $getPropertyString(this.this$01.startDateBox.element, 'value'), $getPropertyString(this.this$01.endDateBox.element, 'value'), (!currentSession && (currentSession = new Session(($clinit_State() , NOT_SIGNED))) , currentSession).email, new ProfessorCourseCreationComponent$confirmCreationButtonHandler$1(this));
      }
       else {
...
_.onClick = function onClick_6(event_0){
  ...
  if (!$equals_1($getPropertyString(this.this$01.courseNameTb.element, 'value'), '') && !$equals_1($getPropertyString(this.this$01.startDateTb.element, 'value'), '') && !$equals_1($getPropertyString(this.this$01.endDateTb.element, 'value'), '')) {
    try {
      ...
      if (gt(fromDouble_0(end.jsdate.getTime()), fromDouble_0(start_0.jsdate.getTime())) && $after(start_0, new Date_0)) {
        !connService && (connService = new ConnService_Proxy);
        $setCourseData(connService, this.this$01.initialCourseName, $getPropertyString(this.this$01.startDateTb.element, 'value'), $getPropertyString(this.this$01.endDateTb.element, 'value'), $getPropertyString(this.this$01.courseNameTb.element, 'value'), new ProfessorCoursesManagementComponent$confirmBtnHandler$1);
      }
       else {
        $wnd.alert('Date inserite non corrette');
...
defineClass(211, 17, $intern_18, RequestCallbackAdapter$ResponseReader$1);
...
defineClass(220, 17, $intern_18, RequestCallbackAdapter$ResponseReader$10);
...
defineClass(221, 17, $intern_18, RequestCallbackAdapter$ResponseReader$11);
...
defineClass(212, 17, $intern_18, RequestCallbackAdapter$ResponseReader$2);
...
defineClass(213, 17, $intern_18, RequestCallbackAdapter$ResponseReader$3);
...
defineClass(214, 17, $intern_18, RequestCallbackAdapter$ResponseReader$4);
...
defineClass(215, 17, $intern_18, RequestCallbackAdapter$ResponseReader$5);
...
defineClass(216, 17, $intern_18, RequestCallbackAdapter$ResponseReader$6);
...
defineClass(217, 17, $intern_18, RequestCallbackAdapter$ResponseReader$7);
...
defineClass(218, 17, $intern_18, RequestCallbackAdapter$ResponseReader$8);
...
defineClass(219, 17, $intern_18, RequestCallbackAdapter$ResponseReader$9);
...
defineClass(50, 93, $intern_19, HorizontalPanel);
...
defineClass(127, 69, $intern_20, RootPanel$DefaultRootPanel);
...
defineClass(206, 28, $intern_21, ValueBoxBase$TextAlignment$1);
...
defineClass(207, 28, $intern_21, ValueBoxBase$TextAlignment$2);
...
defineClass(208, 28, $intern_21, ValueBoxBase$TextAlignment$3);
...
defineClass(209, 28, $intern_21, ValueBoxBase$TextAlignment$4);
...
defineClass(16, 93, $intern_19, VerticalPanel);
...
defineClass(110, 18, $intern_22, UserAgentAsserter$UserAgentAssertionError);
...
defineClass(23, 5, $intern_23, IllegalArgumentException, IllegalArgumentException_0);
...
defineClass(67, 23, $intern_23, NumberFormatException);
...
defineClass(61, 284, $intern_24, AbstractHashMap$EntrySet);
...
defineClass(142, 284, $intern_24, AbstractMap$1);
...
defineClass(29, 288, $intern_26, ArrayList);
...
defineClass(162, 288, $intern_26, Collections$EmptyList);
...
defineClass(168, 289, $intern_25, InternalStringMap$2);
